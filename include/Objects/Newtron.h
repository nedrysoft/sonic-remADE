...
#ifndef NEDRYSOFT_NEWTRON_H
#define NEDRYSOFT_NEWTRON_H
...
namespace Nedrysoft {
    class Newtron :
        ...
        public:
            /**
             * @brief           Constructs a new newtron object.
             *
             ...
             */
            Newtron(int subType, float x, float y, bool rememberState, bool mirrored, bool flipped);
