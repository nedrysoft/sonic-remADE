...
#ifndef NEDRYSOFT_LAMPPOST_H
#define NEDRYSOFT_LAMPPOST_H
...
namespace Nedrysoft {
    ...
    class Lamppost :
        ...
        public:
            /**
             * @brief           Constructs a new lamppost object.
             *
             ...
             */
            Lamppost(int subType, float x, float y, bool rememberState, bool mirrored, bool flipped);
        ...
        private:
            ...
            LamppostColour m_colour;
    };
}

#endif //NEDRYSOFT_LAMPPOST_H
