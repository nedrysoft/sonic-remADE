...
#ifndef NEDRYSOFT_CHOPPER_H
#define NEDRYSOFT_CHOPPER_H
...
namespace Nedrysoft {
    class Chopper :
        ...
        public:
            /**
             * @brief           Constructs a new chopper object.
             *
             ...
             */
            Chopper(int subType, float x, float y, bool rememberState, bool mirrored, bool flipped);
