...
#ifndef NEDRYSOFT_CRABMEATPROJECTILE_H
#define NEDRYSOFT_CRABMEATPROJECTILE_H
...
namespace Nedrysoft {
    ...
    class CrabMeatProjectile :
            public Object {

        public:
            CrabMeatProjectile(float x, float y, float xSign);
...
#endif //NEDRYSOFT_CRABMEATPROJECTILE_H
