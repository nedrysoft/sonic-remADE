...
#ifndef NEDRYSOFT_PURPLEROCK_H
#define NEDRYSOFT_PURPLEROCK_H
...
namespace Nedrysoft {
    ...
    class PurpleRock :
        ...
        public:
            /**
             * @brief           Constructs a new putple rock object.
             *
             ...
             */
            PurpleRock(int subType, float x, float y, bool rememberState, bool mirrored, bool flipped);
