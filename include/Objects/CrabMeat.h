...
#ifndef NEDRYSOFT_CRABMEAT_H
#define NEDRYSOFT_CRABMEAT_H
...
namespace Nedrysoft {
    class CrabMeat :
        ...
        public:
            /**
             * @brief           Constructs a new crabmeat object.
             *
             ...
             */
            CrabMeat(int subType, float x, float y, bool rememberState, bool mirrored, bool flipped);
        ...
        private:
            auto checkCollision(TileMap *tileMap, Camera *camera, class Sonic *sonic) -> bool;

            auto turn() -> void;

            auto onScreen(Camera *camera) -> bool;
