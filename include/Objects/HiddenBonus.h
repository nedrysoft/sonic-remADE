...
#ifndef NEDRYSOFT_HIDDENBONUS_H
#define NEDRYSOFT_HIDDENBONUS_H
...
namespace Nedrysoft {
    ...
    class HiddenBonus :
        ...
        public:
            /**
             * @brief           Constructs a new hidden bonus object.
             *
             ...
             */
            HiddenBonus(int subType, float x, float y, bool rememberState, bool mirrored, bool flipped);
