...
#ifndef NEDRYSOFT_POINTS_H
#define NEDRYSOFT_POINTS_H
...
namespace Nedrysoft {
    ...
    class Points :
        ...
        public:
            /**
             * @brief           Constructs a new points object.
             *
             * @param[in]       value the number of points associated with this instance.
             * @param[in]       x the X coordinate of the object.
             * @param[in]       y the Y coordinate of the object.
             */
            Points(int value, float x, float y);
