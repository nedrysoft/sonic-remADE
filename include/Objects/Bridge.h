...
#ifndef NEDRYSOFT_BRIDGE_H
#define NEDRYSOFT_BRIDGE_H
...
namespace Nedrysoft {
    ...
    class Bridge :
        ...
        public:
            /**
             * @brief           Constructs a new btidge object.
             *
             ...
             */
            Bridge(int subType, float x, float y, bool rememberState, bool mirrored, bool flipped);
        ...
        private:
            static Nedrysoft::Image *m_logImage;
            ...
            std::vector<int> m_maxLogDips;
            std::vector<int> m_logPositions;
