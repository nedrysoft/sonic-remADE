...
#ifndef NEDRYSOFT_SIGNPOST_H
#define NEDRYSOFT_SIGNPOST_H
...
namespace Nedrysoft {
    ...
    class Signpost :
        ...
        public:
            /**
             * @brief           Constructs a new signpost object.
             *
             ...
             */
            Signpost(int subType, float x, float y, bool rememberState, bool mirrored, bool flipped);
