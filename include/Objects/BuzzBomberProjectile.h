...
#ifndef NEDRYSOFT_BUZZBOMBERPROJECTILE_H
#define NEDRYSOFT_BUZZBOMBERPROJECTILE_H
...
namespace Nedrysoft {
    ...
    /**
     * @brief           This object is spawned dynamically by the buzz bomber object, therefore there is no factory
     *                  class, the buzz bomber object behaves as the factory.
     */

    class BuzzBomberProjectile :
            public Object {

        public:
            BuzzBomberProjectile(float x, float y, float xSpeed, float ySpeed);
...
#endif //NEDRYSOFT_BUZZBOMBERPROJECTILE_H
