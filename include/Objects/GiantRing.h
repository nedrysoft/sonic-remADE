...
#ifndef NEDRYSOFT_GIANTRING_H
#define NEDRYSOFT_GIANTRING_H
...
namespace Nedrysoft {
    ...
    class GiantRing :
        ...
        public:
            /**
             * @brief           Constructs a new giant ring object.
             *
             ...
             */
            GiantRing(int subType, float x, float y, bool rememberState, bool mirrored, bool flipped);
        ...
        private:
            Nedrysoft::AnimationPlayer m_animation;

    };
}

#endif //NEDRYSOFT_GIANTRING_H
